...
class SNUNetArch(nn.Module):
    """SNUNet dense Siamese Nested UNet with spatial-temporal attention channel blocks."""
...
class SNUNet(TransformerBaseWrapper):
    """Wrapper class executing the SNUNet baseline."""
    
    def __init__(self, in_channels: int = 18, out_channels: int = 2):
        super().__init__("snunet", SNUNetArch)
