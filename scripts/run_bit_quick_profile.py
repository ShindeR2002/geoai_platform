...
def main():
    ...
    try:
        ...
        if experiment.get_state() == "Completed":
            print("Success! BIT pipeline ran successfully.")
            sys.exit(0)
        else:
            print("Failure: BIT pipeline execution failed.")
            sys.exit(1)
